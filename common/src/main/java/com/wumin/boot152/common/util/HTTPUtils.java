...
public class HTTPUtils {
    ...
    private static HttpURLConnection createConnection(String url,
        ...
        if(headerParameters != null && !headerParameters.containsKey("Content-Type")) {
    ...
    public static String postHeader(String address,Map<String,String> headers,Map<String,String> params) throws Exception {
        return proxyHttpRequest(address,"POST",headers,getRequestBody(params));
    }
    /**
     * GET 带Header
     * @param address
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            params.put("tel", "18688343894");//这是该接口需要的参数
